...
class MainPage(BasePage):
    ...
    def __init__(self, driver, home_url):
        super(MainPage, self).__init__(driver, home_url)
    ...
    def click_continue_button(self):
        ...
        return ShippingPage(self.driver, self.MainPage_Locators.SHIPPING_PAGE_URL)
...
class ShippingPage(BasePage):
    ...
    def __init__(self, driver, home_url):
        super(ShippingPage, self).__init__(driver, home_url)
    ...
    def check_page_loaded(self):
        ...
        if elem_shipping == 'SHIPPING' and self.get_page_url() == self.home_url:
            return True
        else:
            return False
    ...
    def enter_continue_button(self):
        ...
        return VerificationPage(self.driver, self.ShippingPage_Locators.VERIFICATION_PAGE_URL)
...
class VerificationPage(BasePage):
    ...
    def __init__(self, driver, home_url):
        super(VerificationPage, self).__init__(driver, home_url)
    ...
    def check_page_loaded(self):
        ...
        if elem_verify_text and self.get_page_url() == self.home_url:
            return True
        else:
            return False
    ...
    def click_verified_button(self):
        ...
        return BillingPage(self.driver, self.VerificationPage_Locators.BILLING_PAGE_URL)
...
class BillingPage(BasePage):
    ...
    def __init__(self, driver, home_url):
        super(BillingPage, self).__init__(driver, home_url)
    ...
    def check_page_loaded(self):
        ...
        if elem_billing == 'BILLING' and self.get_page_url() == self.home_url:
            return True
        else:
            return False
    ...
    def enter_expiration_date(self, expdate):
        ...
        elem_frame = self.driver.switch_to.frame(
            self.driver.find_element_by_id('braintree-hosted-field-expirationDate'))
    ...
    def enter_ccv_code(self, ccv_code):
        # switch to credit card number iframe
        elem_frame = self.driver.switch_to.frame(self.driver.find_element_by_id('braintree-hosted-field-cvv'))
    ...
    def click_continue_button(self):
        ...
        return ReviewPage(self.driver, self.BillingPage_Locators.REVIEW_PAGE_URL)
